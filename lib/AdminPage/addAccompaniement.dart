...
class FormAccompaniement extends StatefulWidget {
  @override
  AddAccompaniement createState() => AddAccompaniement();
}

class AddAccompaniement extends State<FormAccompaniement> {
          ...
          children: [
            PreferredSize(
              ...
              child: AppBar(
                ...
                title: const Center(child: Text('Add a Accompaniement')),
